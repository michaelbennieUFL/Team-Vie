...
class CompetitionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'challenger', 'challenger_username', 'opponent', 'opponent_username',
                  'status', 'challenger_score', 'opponent_score', 'points_goal', 'winner',
                  'winner_username', 'created_at', 'started_at', 'completed_at', 'tasks', 'server']
        read_only_fields = ['id', 'challenger', 'status', 'challenger_score', 'opponent_score',
                            'winner', 'winner_username', 'created_at', 'started_at', 'completed_at']
